...
var Rho = Rho || (function ($) {
    ...
    var __$$ = {
        ...
        ajax: function (opts) {
            ...
            function stateChangedFor(xhr) {
                return function() {
                    ...
                    if (xhr.status !== 200 && xhr.status !== 0) {
                        ...
                        // It looks like it should return something via HTTP.
                        (opts.error || function () {
            ...
            if (opts.async === true) {
                xhr.onreadystatechange = stateChangedFor(xhr);
            }
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createPropsProxy(Timer.prototype, [
    ], apiReq, function(){ return this.getId(); });

    // === Timer instance methods ===

    rhoUtil.createMethodsProxy(Timer.prototype, [
    
          // function(/* int */ interval, /* optional function */ oResult)
    ...
    rhoUtil.createRawPropsProxy(Timer.prototype, [
    ]);
    ...
    // === Timer static properties ===

    rhoUtil.createPropsProxy(Timer, [
    ], apiReq);

    // === Timer static methods ===

    rhoUtil.createMethodsProxy(Timer, [
    ...
    // === Timer default instance support ===
    

    rhoUtil.namespace(moduleNS, Timer);
...
(function ($, rho, rhoUtil) {
    ...
    // === Printer instance properties ===

    rhoUtil.createPropsProxy(Printer.prototype, [
    ...
    rhoUtil.createMethodsProxy(Printer.prototype, [
    
          // function(/* optional function */ oResult)
          { methodName: 'connect', nativeName: 'connect', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* const rho::Hashtable<rho::String, rho::String>& */ options, /* optional function */ oResult)
        , { methodName: 'connectWithOptions', nativeName: 'connectWithOptions', persistentCallbackIndex: 1, valueCallbackIndex: 3 }
    
          // function(/* const rho::Vector<rho::String>& */ listOfParameters, /* optional function */ oResult)
        , { methodName: 'requestState', nativeName: 'requestState', persistentCallbackIndex: 1, valueCallbackIndex: 3 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'disconnect', nativeName: 'disconnect', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* const rho::String& */ filePathOnDevice, /* const rho::Hashtable<rho::String, rho::String>& */ options, /* optional function */ oResult)
        , { methodName: 'printFile', nativeName: 'printFile', persistentCallbackIndex: 2, valueCallbackIndex: 4 }
    
          // function(/* const rho::String& */ filePathOnDevice, /* int */ x, /* int */ y, /* const rho::Hashtable<rho::String, rho::String>& */ options, /* optional function */ oResult)
        , { methodName: 'printImageFromFile', nativeName: 'printImageFromFile', persistentCallbackIndex: 4, valueCallbackIndex: 6 }
    
          // function(/* const rho::String& */ command, /* const rho::Hashtable<rho::String, rho::String>& */ options, /* optional function */ oResult)
        , { methodName: 'printRawString', nativeName: 'printRawString', persistentCallbackIndex: 2, valueCallbackIndex: 4 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'enumerateSupportedControlLanguages', nativeName: 'enumerateSupportedControlLanguages', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    ...
    rhoUtil.createRawPropsProxy(Printer.prototype, [
    ]);

    // === Printer constants ===

    
            Printer.CONNECTION_TYPE_ANY = 'CONNECTION_TYPE_ANY'; 
    
            Printer.CONNECTION_TYPE_BLUETOOTH = 'CONNECTION_TYPE_BLUETOOTH'; 
    
            Printer.CONNECTION_TYPE_ON_BOARD = 'CONNECTION_TYPE_ON_BOARD'; 
    
            Printer.CONNECTION_TYPE_TCP = 'CONNECTION_TYPE_TCP'; 
    
            Printer.CONNECTION_TYPE_USB = 'CONNECTION_TYPE_USB'; 
    
            Printer.PRINTER_LANGUAGE_CPCL = 'PRINTER_LANGUAGE_CPCL'; 
    
            Printer.PRINTER_LANGUAGE_EPS = 'PRINTER_LANGUAGE_EPS'; 
    
            Printer.PRINTER_LANGUAGE_ZPL = 'PRINTER_LANGUAGE_ZPL'; 
    
            Printer.PRINTER_STATE_IS_BATTERY_LOW = 'PRINTER_STATE_IS_BATTERY_LOW'; 
    
            Printer.PRINTER_STATE_IS_COVER_OPENED = 'PRINTER_STATE_IS_COVER_OPENED'; 
    
            Printer.PRINTER_STATE_IS_DRAWER_OPENED = 'PRINTER_STATE_IS_DRAWER_OPENED'; 
    
            Printer.PRINTER_STATE_IS_PAPER_OUT = 'PRINTER_STATE_IS_PAPER_OUT'; 
    
            Printer.PRINTER_STATE_IS_READY_TO_PRINT = 'PRINTER_STATE_IS_READY_TO_PRINT'; 
    
            Printer.PRINTER_STATUS_ERROR = 'PRINTER_STATUS_ERROR'; 
    
            Printer.PRINTER_STATUS_ERR_IO = 'PRINTER_STATUS_ERR_IO'; 
    
            Printer.PRINTER_STATUS_ERR_MEMORY = 'PRINTER_STATUS_ERR_MEMORY'; 
    
            Printer.PRINTER_STATUS_ERR_NETWORK = 'PRINTER_STATUS_ERR_NETWORK'; 
    
            Printer.PRINTER_STATUS_ERR_NOT_CONNECTED = 'PRINTER_STATUS_ERR_NOT_CONNECTED'; 
    
            Printer.PRINTER_STATUS_ERR_NOT_FOUND = 'PRINTER_STATUS_ERR_NOT_FOUND'; 
    
            Printer.PRINTER_STATUS_ERR_PARAM = 'PRINTER_STATUS_ERR_PARAM'; 
    
            Printer.PRINTER_STATUS_ERR_PROCESSING = 'PRINTER_STATUS_ERR_PROCESSING'; 
    
            Printer.PRINTER_STATUS_ERR_RESPONSE = 'PRINTER_STATUS_ERR_RESPONSE'; 
    
            Printer.PRINTER_STATUS_ERR_TIMEOUT = 'PRINTER_STATUS_ERR_TIMEOUT'; 
    
            Printer.PRINTER_STATUS_ERR_UNSUPPORTED = 'PRINTER_STATUS_ERR_UNSUPPORTED'; 
    
            Printer.PRINTER_STATUS_SUCCESS = 'PRINTER_STATUS_SUCCESS'; 
    
            Printer.PRINTER_TYPE_ANY = 'PRINTER_TYPE_ANY'; 
    
            Printer.PRINTER_TYPE_APD = 'PRINTER_TYPE_APD'; 
    
            Printer.PRINTER_TYPE_EPSON = 'PRINTER_TYPE_EPSON'; 
    
            Printer.PRINTER_TYPE_NATIVE = 'PRINTER_TYPE_NATIVE'; 
    
            Printer.PRINTER_TYPE_ZEBRA = 'PRINTER_TYPE_ZEBRA'; 
    



    // === Printer static properties ===

    rhoUtil.createPropsProxy(Printer, [
    ], apiReq);

    // === Printer static methods ===

    rhoUtil.createMethodsProxy(Printer, [
    
          // function(/* optional function */ oResult)
          { methodName: 'enumerateSupportedTypes', nativeName: 'enumerateSupportedTypes', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* const rho::Hashtable<rho::String, rho::String>& */ options, /* optional function */ oResult)
        , { methodName: 'searchPrinters', nativeName: 'searchPrinters', persistentCallbackIndex: 1, valueCallbackIndex: 3 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'stopSearch', nativeName: 'stopSearch', valueCallbackIndex: 0 }
    
          // function(/* const rho::String& */ printerId, /* optional function */ oResult)
        , { methodName: 'getPrinterByID', nativeName: 'getPrinterByID', valueCallbackIndex: 1 }
    ...
    // === Printer default instance support ===
    

        rhoUtil.createPropsProxy(Printer, [
            { propName: 'defaultInstance:getDefault:setDefault', propAccess: 'rw', customSet: function(obj) { if(!obj || 'function' != typeof obj.getId){ throw 'Default object should provide getId method!' }; Printer.setDefaultID(obj.getId()); } }
          , { propName: 'defaultID:getDefaultID:setDefaultID', propAccess: 'rw' }
        ], apiReq);

        Printer.getId = function() {
            return Printer.getDefaultID();
        }

        // === Printer default instance properties ===
        ...
        // === Printer default instance methods ===
        ...
        // will reuse already defined methods
        rhoUtil.createRawPropsProxy(Printer, [
        ]);

    

    rhoUtil.namespace(moduleNS, Printer);
...
// Module Rho.PrinterZebra


(function ($, rho, rhoUtil) {
    'use strict';

    var moduleNS = 'Rho.PrinterZebra';
    var apiReq = rhoUtil.apiReqFor(moduleNS);


    // === PrinterZebra class definition ===

    function PrinterZebra() {
        var id = null;
        this.getId = function () {return id;};
    ...
    // === PrinterZebra instance properties ===

    rhoUtil.createPropsProxy(PrinterZebra.prototype, [
        { propName: 'ID', propAccess: 'r' }
      , { propName: 'deviceName', propAccess: 'r' }
      , { propName: 'printerType', propAccess: 'r' }
      , { propName: 'deviceAddress', propAccess: 'r' }
    ...
    // === PrinterZebra instance methods ===

    rhoUtil.createMethodsProxy(PrinterZebra.prototype, [
        ...
        , { methodName: 'enumerateSupportedControlLanguages', nativeName: 'enumerateSupportedControlLanguages', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
          ...
          // function(/* optional function */ oResult)
        , { methodName: 'retrieveFileNames', nativeName: 'retrieveFileNames', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* const rho::Vector<rho::String>& */ extensions, /* optional function */ oResult)
        , { methodName: 'retrieveFileNamesWithExtensions', nativeName: 'retrieveFileNamesWithExtensions', persistentCallbackIndex: 1, valueCallbackIndex: 3 }
    
          // function(/* const rho::String& */ path, /* optional function */ oResult)
        , { methodName: 'sendFileContents', nativeName: 'sendFileContents', persistentCallbackIndex: 1, valueCallbackIndex: 3 }
    
          // function(/* const rho::String& */ formatPathOnPrinter, /* const rho::Hashtable<rho::String, rho::String>& */ vars, /* optional function */ oResult)
        , { methodName: 'printStoredFormatWithHash', nativeName: 'printStoredFormatWithHash', persistentCallbackIndex: 2, valueCallbackIndex: 4 }
    
          // function(/* const rho::String& */ formatPathOnPrinter, /* const rho::Vector<rho::String>& */ vars, /* optional function */ oResult)
        , { methodName: 'printStoredFormatWithArray', nativeName: 'printStoredFormatWithArray', persistentCallbackIndex: 2, valueCallbackIndex: 4 }
    
          // function(/* const rho::String& */ printerDriveAndFileName, /* const rho::String& */ imageFilePathOnDevice, /* int */ width, /* int */ height, /* optional function */ oResult)
        , { methodName: 'storeImage', nativeName: 'storeImage', persistentCallbackIndex: 4, valueCallbackIndex: 6 }
    ...
    rhoUtil.createRawPropsProxy(PrinterZebra.prototype, [
    ]);

    // === PrinterZebra constants ===

    
            PrinterZebra.CONNECTION_TYPE_ANY = 'CONNECTION_TYPE_ANY'; 
    
            PrinterZebra.CONNECTION_TYPE_BLUETOOTH = 'CONNECTION_TYPE_BLUETOOTH'; 
    
            PrinterZebra.CONNECTION_TYPE_ON_BOARD = 'CONNECTION_TYPE_ON_BOARD'; 
    
            PrinterZebra.CONNECTION_TYPE_TCP = 'CONNECTION_TYPE_TCP'; 
    
            PrinterZebra.CONNECTION_TYPE_USB = 'CONNECTION_TYPE_USB'; 
    
            PrinterZebra.DISCOVERY_MODE_DIRECTED_BROADCAST = 'DISCOVERY_MODE_DIRECTED_BROADCAST'; 
    
            PrinterZebra.DISCOVERY_MODE_LOCAL_BROADCAST = 'DISCOVERY_MODE_LOCAL_BROADCAST'; 
    
            PrinterZebra.DISCOVERY_MODE_MULTICAST = 'DISCOVERY_MODE_MULTICAST'; 
    
            PrinterZebra.DISCOVERY_MODE_SUBNET_SEARCH = 'DISCOVERY_MODE_SUBNET_SEARCH'; 
    
            PrinterZebra.ERROR_BAD_FILE_DIRECTORY_ENTRY = 'ERROR_BAD_FILE_DIRECTORY_ENTRY'; 
    
            PrinterZebra.ERROR_INVALID_DISCOVERY_HOP_COUNT = 'ERROR_INVALID_DISCOVERY_HOP_COUNT'; 
    
            PrinterZebra.ERROR_INVALID_FILE_NAME = 'ERROR_INVALID_FILE_NAME'; 
    
            PrinterZebra.ERROR_INVALID_FORMAT_NAME = 'ERROR_INVALID_FORMAT_NAME'; 
    
            PrinterZebra.ERROR_INVALID_PRINTER_DRIVE_LETTER = 'ERROR_INVALID_PRINTER_DRIVE_LETTER'; 
    
            PrinterZebra.ERROR_INVALID_PRINTER_LANGUAGE = 'ERROR_INVALID_PRINTER_LANGUAGE'; 
    
            PrinterZebra.ERROR_MALFORMED_FORMAT_FIELD_NUMBER = 'ERROR_MALFORMED_FORMAT_FIELD_NUMBER'; 
    
            PrinterZebra.ERROR_MALFORMED_NETWORK_DISCOVERY_ADDRESS = 'ERROR_MALFORMED_NETWORK_DISCOVERY_ADDRESS'; 
    
            PrinterZebra.ERROR_MALFORMED_PRINTER_STATUS_RESPONSE = 'ERROR_MALFORMED_PRINTER_STATUS_RESPONSE'; 
    
            PrinterZebra.ERROR_NETWORK_ERROR_DURING_DISCOVERY = 'ERROR_NETWORK_ERROR_DURING_DISCOVERY'; 
    
            PrinterZebra.ERROR_NO_CONNECTION = 'ERROR_NO_CONNECTION'; 
    
            PrinterZebra.ERROR_READ_FAILURE = 'ERROR_READ_FAILURE'; 
    
            PrinterZebra.ERROR_UNKNOWN_PRINTER_LANGUAGE = 'ERROR_UNKNOWN_PRINTER_LANGUAGE'; 
    
            PrinterZebra.ERROR_WRITE_FAILURE = 'ERROR_WRITE_FAILURE'; 
    
            PrinterZebra.PRINTER_LANGUAGE_CPCL = 'PRINTER_LANGUAGE_CPCL'; 
    
            PrinterZebra.PRINTER_LANGUAGE_EPS = 'PRINTER_LANGUAGE_EPS'; 
    
            PrinterZebra.PRINTER_LANGUAGE_ZPL = 'PRINTER_LANGUAGE_ZPL'; 
    
            PrinterZebra.PRINTER_STATE_IS_BATTERY_LOW = 'PRINTER_STATE_IS_BATTERY_LOW'; 
    
            PrinterZebra.PRINTER_STATE_IS_COVER_OPENED = 'PRINTER_STATE_IS_COVER_OPENED'; 
    
            PrinterZebra.PRINTER_STATE_IS_DRAWER_OPENED = 'PRINTER_STATE_IS_DRAWER_OPENED'; 
    
            PrinterZebra.PRINTER_STATE_IS_HEAD_COLD = 'PRINTER_STATE_IS_HEAD_COLD'; 
    
            PrinterZebra.PRINTER_STATE_IS_HEAD_OPEN = 'PRINTER_STATE_IS_HEAD_OPEN'; 
    
            PrinterZebra.PRINTER_STATE_IS_HEAD_TOO_HOT = 'PRINTER_STATE_IS_HEAD_TOO_HOT'; 
    
            PrinterZebra.PRINTER_STATE_IS_PAPER_OUT = 'PRINTER_STATE_IS_PAPER_OUT'; 
    
            PrinterZebra.PRINTER_STATE_IS_PARTIAL_FORMAT_IN_PROGRESS = 'PRINTER_STATE_IS_PARTIAL_FORMAT_IN_PROGRESS'; 
    
            PrinterZebra.PRINTER_STATE_IS_PAUSED = 'PRINTER_STATE_IS_PAUSED'; 
    
            PrinterZebra.PRINTER_STATE_IS_READY_TO_PRINT = 'PRINTER_STATE_IS_READY_TO_PRINT'; 
    
            PrinterZebra.PRINTER_STATE_IS_RECEIVE_BUFFER_FULL = 'PRINTER_STATE_IS_RECEIVE_BUFFER_FULL'; 
    
            PrinterZebra.PRINTER_STATE_IS_RIBBON_OUT = 'PRINTER_STATE_IS_RIBBON_OUT'; 
    
            PrinterZebra.PRINTER_STATE_LABELS_REMAINING_IN_BATCH = 'PRINTER_STATE_LABELS_REMAINING_IN_BATCH'; 
    
            PrinterZebra.PRINTER_STATE_LABEL_LENGTH_IN_DOTS = 'PRINTER_STATE_LABEL_LENGTH_IN_DOTS'; 
    
            PrinterZebra.PRINTER_STATE_NUMBER_OF_FORMATS_IN_RECEIVE_BUFFER = 'PRINTER_STATE_NUMBER_OF_FORMATS_IN_RECEIVE_BUFFER'; 
    
            PrinterZebra.PRINTER_STATE_PRINT_MODE = 'PRINTER_STATE_PRINT_MODE'; 
    
            PrinterZebra.PRINTER_STATUS_ERROR = 'PRINTER_STATUS_ERROR'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_IO = 'PRINTER_STATUS_ERR_IO'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_MEMORY = 'PRINTER_STATUS_ERR_MEMORY'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_NETWORK = 'PRINTER_STATUS_ERR_NETWORK'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_NOT_CONNECTED = 'PRINTER_STATUS_ERR_NOT_CONNECTED'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_NOT_FOUND = 'PRINTER_STATUS_ERR_NOT_FOUND'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_PARAM = 'PRINTER_STATUS_ERR_PARAM'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_PROCESSING = 'PRINTER_STATUS_ERR_PROCESSING'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_RESPONSE = 'PRINTER_STATUS_ERR_RESPONSE'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_TIMEOUT = 'PRINTER_STATUS_ERR_TIMEOUT'; 
    
            PrinterZebra.PRINTER_STATUS_ERR_UNSUPPORTED = 'PRINTER_STATUS_ERR_UNSUPPORTED'; 
    
            PrinterZebra.PRINTER_STATUS_SUCCESS = 'PRINTER_STATUS_SUCCESS'; 
    
            PrinterZebra.PRINTER_TYPE_ANY = 'PRINTER_TYPE_ANY'; 
    
            PrinterZebra.PRINTER_TYPE_APD = 'PRINTER_TYPE_APD'; 
    
            PrinterZebra.PRINTER_TYPE_EPSON = 'PRINTER_TYPE_EPSON'; 
    
            PrinterZebra.PRINTER_TYPE_NATIVE = 'PRINTER_TYPE_NATIVE'; 
    
            PrinterZebra.PRINTER_TYPE_ZEBRA = 'PRINTER_TYPE_ZEBRA'; 
    
            PrinterZebra.PRINT_MODE_APPLICATOR = 'PRINT_MODE_APPLICATOR'; 
    
            PrinterZebra.PRINT_MODE_CUTTER = 'PRINT_MODE_CUTTER'; 
    
            PrinterZebra.PRINT_MODE_DELAYED_CUT = 'PRINT_MODE_DELAYED_CUT'; 
    
            PrinterZebra.PRINT_MODE_KIOSK = 'PRINT_MODE_KIOSK'; 
    
            PrinterZebra.PRINT_MODE_LINERLESS_PEEL = 'PRINT_MODE_LINERLESS_PEEL'; 
    
            PrinterZebra.PRINT_MODE_LINERLESS_REWIND = 'PRINT_MODE_LINERLESS_REWIND'; 
    
            PrinterZebra.PRINT_MODE_PARTIAL_CUTTER = 'PRINT_MODE_PARTIAL_CUTTER'; 
    
            PrinterZebra.PRINT_MODE_PEEL_OFF = 'PRINT_MODE_PEEL_OFF'; 
    
            PrinterZebra.PRINT_MODE_REWIND = 'PRINT_MODE_REWIND'; 
    
            PrinterZebra.PRINT_MODE_RFID = 'PRINT_MODE_RFID'; 
    
            PrinterZebra.PRINT_MODE_TEAR_OFF = 'PRINT_MODE_TEAR_OFF'; 
    
            PrinterZebra.PRINT_MODE_UNKNOWN = 'PRINT_MODE_UNKNOWN'; 
    



    // === PrinterZebra static properties ===

    rhoUtil.createPropsProxy(PrinterZebra, [
    ], apiReq);

    // === PrinterZebra static methods ===

    rhoUtil.createMethodsProxy(PrinterZebra, [
    ...
    // === PrinterZebra default instance support ===
    

        rhoUtil.createPropsProxy(PrinterZebra, [
            { propName: 'defaultInstance:getDefault:setDefault', propAccess: 'rw', customSet: function(obj) { if(!obj || 'function' != typeof obj.getId){ throw 'Default object should provide getId method!' }; PrinterZebra.setDefaultID(obj.getId()); } }
          , { propName: 'defaultID:getDefaultID:setDefaultID', propAccess: 'rw' }
        ], apiReq);

        PrinterZebra.getId = function() {
            return PrinterZebra.getDefaultID();
        }

        // === PrinterZebra default instance properties ===
        ...
        // === PrinterZebra default instance methods ===
        ...
        // will reuse already defined methods
        rhoUtil.createRawPropsProxy(PrinterZebra, [
        ]);

    

    rhoUtil.namespace(moduleNS, PrinterZebra);
...
// Module Rho.RhoconnectPush


(function ($, rho, rhoUtil) {
    'use strict';

    var moduleNS = 'Rho.RhoconnectPush';
    var apiReq = rhoUtil.apiReqFor(moduleNS);


    // === RhoconnectPush class definition ===

    function RhoconnectPush() {
        var id = null;
        this.getId = function () {return id;};
    ...
    // === RhoconnectPush instance properties ===

    rhoUtil.createPropsProxy(RhoconnectPush.prototype, [
    ], apiReq, function(){ return this.getId(); });

    // === RhoconnectPush instance methods ===

    rhoUtil.createMethodsProxy(RhoconnectPush.prototype, [
    
    ], apiReq, function(){ return this.getId(); });

    

    rhoUtil.createRawPropsProxy(RhoconnectPush.prototype, [
    ]);

    // === RhoconnectPush constants ===

    



    // === RhoconnectPush static properties ===

    rhoUtil.createPropsProxy(RhoconnectPush, [
    ], apiReq);

    // === RhoconnectPush static methods ===

    rhoUtil.createMethodsProxy(RhoconnectPush, [
    
    ], apiReq);

    // === RhoconnectPush default instance support ===
    

    rhoUtil.namespace(moduleNS, RhoconnectPush);
...
// Module Rho.ScreenOrientation


(function ($, rho, rhoUtil) {
    'use strict';

    var moduleNS = 'Rho.ScreenOrientation';
    var apiReq = rhoUtil.apiReqFor(moduleNS);


    // === ScreenOrientation class definition ===
    ...
    // === ScreenOrientation instance properties ===

    rhoUtil.createPropsProxy(ScreenOrientation.prototype, [
    ], apiReq, function(){ return this.getId(); });

    // === ScreenOrientation instance methods ===

    rhoUtil.createMethodsProxy(ScreenOrientation.prototype, [
    
    ], apiReq, function(){ return this.getId(); });

    

    rhoUtil.createRawPropsProxy(ScreenOrientation.prototype, [
    ]);
    ...
    // === ScreenOrientation static properties ===

    rhoUtil.createPropsProxy(ScreenOrientation, [
        { propName: 'autoRotate', propAccess: 'rw' }
    ], apiReq);

    // === ScreenOrientation static methods ===

    rhoUtil.createMethodsProxy(ScreenOrientation, [
    
          // function(/* optional function */ oResult)
          { methodName: 'normal', nativeName: 'normal', valueCallbackIndex: 0 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'rightHanded', nativeName: 'rightHanded', valueCallbackIndex: 0 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'leftHanded', nativeName: 'leftHanded', valueCallbackIndex: 0 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'upsideDown', nativeName: 'upsideDown', valueCallbackIndex: 0 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'setScreenOrientationEvent', nativeName: 'setScreenOrientationEvent', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
    ], apiReq);

    // === ScreenOrientation default instance support ===
    

    rhoUtil.namespace(moduleNS, ScreenOrientation);
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createRawPropsProxy(Sensor.prototype, [
    ]);
    ...
    rhoUtil.createMethodsProxy(Sensor, [
          ...
          { methodName: 'makeSensorByType', nativeName: 'makeSensorByType', valueCallbackIndex: 1 }
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createPropsProxy(Device.prototype, [
    ], apiReq, function(){ return this.getId(); });

    // === Device instance methods ===

    rhoUtil.createMethodsProxy(Device.prototype, [
    
    ], apiReq, function(){ return this.getId(); });

    

    rhoUtil.createRawPropsProxy(Device.prototype, [
    ]);
    ...
    rhoUtil.createPropsProxy(Device, [
    ], apiReq);

    // === Device static methods ===

    rhoUtil.createMethodsProxy(Device, [
    
          // function(/* optional function */ oResult)
          { methodName: 'calibrate', nativeName: 'calibrate', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'suspend', nativeName: 'suspend', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'powerOff', nativeName: 'powerOff', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'idle', nativeName: 'idle', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'wake', nativeName: 'wake', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* const rho::String& */ bootType, /* optional function */ oResult)
        , { methodName: 'reboot', nativeName: 'reboot', persistentCallbackIndex: 1, valueCallbackIndex: 3 }
    
    ], apiReq);

    // === Device default instance support ===
    

    rhoUtil.namespace(moduleNS, Device);
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createRawPropsProxy(Battery.prototype, [
    ]);
    ...
    rhoUtil.createMethodsProxy(Battery, [
        ...
        , { methodName: 'smartBatteryStatus', nativeName: 'smartBatteryStatus', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
          ...
          // function(/* optional function */ oResult)
        , { methodName: 'batteryDiagnostics', nativeName: 'batteryDiagnostics', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createRawPropsProxy(KeyState.prototype, [
    ]);
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createRawPropsProxy(SignalIndicators.prototype, [
    ]);
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createRawPropsProxy(CardReader.prototype, [
    ]);
    ...
    // === CardReader default instance support ===
        ...
        rhoUtil.createPropsProxy(CardReader, [
            { propName: 'defaultInstance:getDefault:setDefault', propAccess: 'rw', customSet: function(obj) { if(!obj || 'function' != typeof obj.getId){ throw 'Default object should provide getId method!' }; CardReader.setDefaultID(obj.getId()); } }
          , { propName: 'defaultID:getDefaultID:setDefaultID', propAccess: 'rw' }
        ], apiReq);

        CardReader.getId = function() {
            return CardReader.getDefaultID();
        }
        ...
        // will reuse already defined methods
        rhoUtil.createRawPropsProxy(CardReader, [
        ]);
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createRawPropsProxy(KeyCapture.prototype, [
    ]);
